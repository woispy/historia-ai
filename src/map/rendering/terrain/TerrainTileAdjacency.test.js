...
assert.equal(plan.north.transition, "neighbor-coarser"); assert.equal(plan.east.transition, "same"); assert.equal(plan.south.transition, "neighbor-finer");
...
assert.equal(planTerrainLodSeams(3, coarseAdjacency).north.transition, "neighbor-coarser");
...
assert.equal(planTerrainLodSeams(3, fineAdjacency).north.transition, "neighbor-finer");
