...
void main(){
  ...
  gl_Position=uMvp*vec4(world,aHeight*uHeightScale,1.0);
}`;
...
export class TerrainGpuRenderer {
  constructor(gl, material = TERRAIN_MATERIAL_DEFAULTS) {
    ...
    this.gl = gl; this.material = { ...TERRAIN_MATERIAL_DEFAULTS, heightScale: 0.001, ...material }; this.program = createProgram(gl); this.tiles = new Map(); this.disposed = false;
