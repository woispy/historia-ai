 ...
 * geographic fact for the province; vague "coastal streams" or generic basin
 * labels are deliberately omitted so the inspector never reports a river
 * merely because a province is near water.
 */
...
export const ANATOLIA_1300_PROVINCE_HYDROGRAPHY = Object.freeze({
  ...
  "bithynia-sangarios": river("Sakarya (Sangarios)", "Ana Sakarya koridoru ve tarihsel sınır nehri"),
  "phrygia-sogut": river("Sakarya havzası", "Söğüt çevresindeki üst Sakarya havzası"),
  ...
  "phrygia-denizli": river("Büyük Menderes (Maiandros)", "Denizli/Lâdik çevresindeki ana vadi sistemi"),
  ...
  "cappadocia-kayseri": river("Zamantı Irmağı", "Seyhan sisteminin üst kolu"),
  "cappadocia-sivas": river("Kızılırmak (Halys)", "Sivas çevresinin ana nehir sistemi"),
  "lycaonia-konya": river("Çarşamba Çayı", "Konya ovasının önemli akarsu sistemi"),

  "pontus-amisos": river("Kızılırmak (Halys)", "Samsun/Amisos hinterlandında Karadeniz'e ulaşan büyük nehir"),
  ...
  "cilicia-alaiye": river("Dim Çayı", "Alanya çevresindeki başlıca kıyı akarsularından biri"),
});
