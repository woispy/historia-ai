...
function ProvinceLayer({
  ...
  // province as an invisible SVG hit path still forces the browser to layout,
  // retain and hit-test hundreds/thousands of complex paths every frame.
  // Province interaction becomes active only when the player is close enough
  // to meaningfully target an individual province.
