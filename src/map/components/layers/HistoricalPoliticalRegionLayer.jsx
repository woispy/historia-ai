  ...
  return (
    <g pointerEvents="none" aria-label="1300 historical political map">
      ...
      <g clipPath={`url(#${HISTORICAL_WORLD_POLITICAL_CLIP_ID})`}>
        ...
        {/* Legacy Anatolia regional polygons are excluded. Non-Anatolian
            historical GIS remains visible outside the curated override. */}
        <g mask={`url(#${HISTORICAL_WORLD_SOURCE_MASK_ID})`}>
          <HistoricalWorldRegionPaths regions={nonAnatoliaRegions} />
        </g>

        {/* Coastal closure uses only the already-authoritative province path.
            The world-land clip remains the final anti-sea-spill boundary. */}
        <g>
