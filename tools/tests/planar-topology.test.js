...
// It gives us a valid closed graph without depending on the future tessellator.
const nodes = [
  createTopologyNode({ id: 1, lon: 0, lat: 0, incidentArcs: [1, 2, 3] }),
  createTopologyNode({ id: 2, lon: 1, lat: 0, incidentArcs: [1, 4, 5] }),
  createTopologyNode({ id: 3, lon: 0.5, lat: 1, incidentArcs: [2, 4, 6] }),
  createTopologyNode({ id: 4, lon: 0.5, lat: 0.35, incidentArcs: [3, 5, 6] }),
];
const arcs = [
  ...
  createTopologyArc({ id: 4, startNode: 2, endNode: 3, leftFace: 2, rightFace: 3, points: [[1, 0], [0.5, 1]] }),
  createTopologyArc({ id: 5, startNode: 4, endNode: 2, leftFace: 2, rightFace: 4, points: [[0.5, 0.35], [1, 0]] }),
...
const faces = [
  ...
  createTopologyFace({ id: 3, seedId: 103, outerArcIds: [2, 6, 4] }),
  createTopologyFace({ id: 4, seedId: 104, outerArcIds: [3, 5, 6] }),
];
