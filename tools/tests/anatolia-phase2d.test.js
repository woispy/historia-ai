...
import { buildAnatoliaPhase2DAssets, isAnatoliaGeometryPoint } from "../historical-gis/AnatoliaPhase2DGeometryBuilder.js";
...
console.log(`Phase 2D Anatolia geometry tests passed: ${result.provinceCount} provinces, ${result.siteCount} sites, ${result.polygonCount} cartographic polygons.`);
