...
for (const method of ["initialize", "resize", "setCamera", "setSelectedProvinceId", "setHoveredProvinceId", "pick", "render", "dispose"]) {
...
assert.match(controller, /setHoveredProvinceId/);
...
console.log("Map Engine v2 contract passed: renderer-neutral lifecycle, imperative interaction ownership, 1x1 picking target, typed province state, quadtree foundation and clamped 2.5D camera.");
