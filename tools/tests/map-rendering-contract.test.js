...
console.log("Map rendering contract passed: production WebGL2 renderer owns map input/camera state, uses real triangle-list geometry, maps picking through the active camera, and province selection cannot reset the runtime camera.");
