...
assert.equal(copernicusTileLatitudeCoordinate(43), 42);
assert.equal(copernicusTileLongitudeCoordinate(36), 36);
assert.equal(copernicusTileLatitudeCoordinate(39.25), 39);
assert.equal(copernicusTileLongitudeCoordinate(36.25), 36);
assert.equal(copernicusTileKey(39, 36), "Copernicus_DSM_COG_10_N38_00_E036_00_DEM");
assert.equal(copernicusTileKey(39.25, 36), "Copernicus_DSM_COG_10_N39_00_E036_00_DEM");
...
assert.equal(sourceTiles.at(-1), "Copernicus_DSM_COG_10_N41_00_E045_00_DEM");
...
const spatialRaster = { width: 3600, height: 3600, georeference: { originX: 36, originY: 40, scaleX: 1 / 3600, scaleY: 1 / 3600 } };
const spatial = validateCopernicusTileGeoreference("Copernicus_DSM_COG_10_N39_00_E036_00_DEM", spatialRaster);
assert.equal(spatial.georefMatchesTile, true);
const wrongSpatial = validateCopernicusTileGeoreference("Copernicus_DSM_COG_10_N39_00_E036_00_DEM", { ...spatialRaster, georeference: { ...spatialRaster.georeference, originX: 26, originY: 43 } });
