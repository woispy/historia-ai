...
const nodataValidation = validateDemRaster(nodataRaster);
assert.deepEqual(nodataValidation, { width: 2, height: 2, validSamples: 3, min: 0, max: 30, noDataValue: -9999 });
...
assert.throws(() => validateDemRaster({ width: 2, height: 2, samples: [0, -9999, -9999, 30], noDataValue: -9999 }), /no valid/);
